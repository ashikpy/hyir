          ...
          >
            ...
            <div className="p-5 space-y-4">
              <div className="space-y-1.5">
                ...
                >
                  {Object.keys(TimelineEventType).map(type => (
              ...
              <div className="space-y-1.5">
                ...
                <textarea 
                  name="description"
                  rows={3}
                  placeholder="E.g. Sent thank you email..."
                  className="w-full bg-zinc-900/50 border border-zinc-800 rounded-lg py-2 px-3 text-sm text-zinc-100 focus:outline-none focus:border-zinc-500 resize-none"
                />
              </div>
            </div>
